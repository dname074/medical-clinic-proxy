...
//
//    @Test
//    void getVisitsByDateAndDoctorSpecialization_ResponseStatus200_Filtered_VisitsPageReturned() throws JsonProcessingException {
...
//                                .withStatus(200)
//                ));
//        PageDto<VisitDto> result = client.getFilteredVisits(specialization, date, page, size);
//
//        Assertions.assertAll(
//                () -> assertEquals(visitPage.content(), result.content()),
//                () -> assertEquals(1, result.totalPages()),
