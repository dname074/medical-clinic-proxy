...
//
//    @Test
//    void getVisitsByDateAndSpecialization_DoctorFound_Filtered_VisitsReturned() {
...
//        List<VisitDto> visits = List.of(createVisit());
//        PageDto<VisitDto> visitsPage = new PageDto<>(visits, 1, 0, 1);
//        when(client.getFilteredVisits(specialization, date, page, size)).thenReturn(visitsPage);
//
//        PageDto<VisitDto> result = service.getFilteredVisits(specialization, date, page, size);
//
//        Assertions.assertAll(
//                () -> assertEquals(visits, result.content()),
//                () -> assertEquals(0, result.pageNumber()),
...
//                () -> assertEquals(1, result.totalPages())
//        );
//        verify(client, times(1)).getFilteredVisits(specialization, date, 0, 1);
//        verifyNoMoreInteractions(client);
//    }
//
//    @Test
//    void getFilteredVisitsByDateAndSpecialization_OldDatePassed_ExceptionThrown() {
//        Specialization specialization = Specialization.DERMATOLOGIST;
...
//                () -> service.getFilteredVisits(specialization, date, page, size));
