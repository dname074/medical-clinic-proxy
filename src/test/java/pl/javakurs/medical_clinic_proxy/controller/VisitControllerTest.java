...
//
//    @Test
//    void getVisitsByDateAndSpecialization_VisitsFound_Filtered_VisitsReturned() throws Exception {
...
//        List<VisitDto> visits = List.of(createVisit());
//        PageDto<VisitDto> pageDto = new PageDto<>(visits, 1, 0, 1);
//        when(service.getFilteredVisits(specialization, date, page, size)).thenReturn(pageDto);
//
...
//                .andExpect(jsonPath("$.pageNumber").value(0))
//                .andExpect(jsonPath("$.pageSize").value(1));
//        verify(service, times(1)).getFilteredVisits(specialization, date, 0, 1);
//        verifyNoMoreInteractions(service);
//    }
//
//    @Test
//    void getVisitsByDateAndSpecialization_VisitsNotFound_Filtered_VisitsReturned() throws Exception {
//        Specialization specialization = Specialization.DERMATOLOGIST;
//        LocalDate date = LocalDate.of(2027, 1, 1);
//        int page = 0;
//        int size = 1;
