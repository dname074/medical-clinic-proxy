...
import pl.javakurs.dname074.dto.FilteredVisitsRequest;
...
class VisitController {
    ...
    public PageDto<VisitDto> getPatientVisits(@PathVariable @NotNull Long id,
        ...
        log.info("Received GET /patient/{}/visits request with params page = {} and size = {}", id, page, size);
    ...
    public PageDto<VisitDto> getDoctorVisits(@PathVariable @NotNull Long id, @RequestParam(required = false) VisitStatus status,
                                             @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "10") Integer size) {
        log.info("Received GET /doctor/{}/visits request with params status = {}, page = {} and size = {}", id, status, page, size);
    ...
    public PageDto<VisitForPatientDto> getFilteredVisits(@Valid FilteredVisitsRequest request) {
        log.info("Received GET /patient/visits request with params fromDate = {}, toDate = {}, exact date= {}, specialization = {}, status = {}, page = {} and size = {}",
    ...
    public VisitDto assignPatientToVisit(@PathVariable @NotNull Long visitId, @PathVariable @NotNull Long patientId) {
        log.info("Received PATCH /patient/{}/visits/{} request", patientId, visitId);
    ...
    public VisitDto cancelVisit(@PathVariable @NotNull Long id) {
        log.info("Received PATCH /doctor/visits/{} request", id);
